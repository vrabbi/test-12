...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=vrabbi&repo=test-12",
  "owner" : "platform-team",
  "system" : "demo-apps"
}
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->test-12]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=vrabbi&repo=test-12'
